...
class SAML2Backend(Saml2Backend):
    ...
    def authenticate(self, request, session_info=None, attribute_mapping=None,
        ...
        try:
            ...
            uuid = self.joinval(self.extractby_keyoid('eduPersonUniqueId',
                                                      attributes))
        except KeyError:
            pass
        ...
        if created:
            ...
            cache.set_many({'saml2_username': user.username,
                            'saml2_first_name': user.first_name,
                            'saml2_last_name': user.last_name,
                            'saml2_is_superuser': user.is_superuser})
